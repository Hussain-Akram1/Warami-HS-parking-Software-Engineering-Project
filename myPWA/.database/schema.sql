-- Warami High School Parking Roster Database Schema (SQLite)
...
-- Insert faculty data
INSERT INTO faculty_colors (faculty_name, color_code, staff_count) VALUES
('English', '#FF6B6B', 15),
